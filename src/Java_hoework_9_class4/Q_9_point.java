...
/* 9. You have to represent a point in 2D space. Write a class with the name Point. The class needs two
...
public class Q_9_point {
    ...
    public double distance(Q_9_point another) {
        return distance(another.x, another.y);
    }

    public static void main(String[] args) {
        Q_9_point first = new Q_9_point(6, 5);
        Q_9_point second = new Q_9_point(3, 1);

        System.out.println("distance(0,0)= " + first.distance());
        System.out.println("distance(second)= " + first.distance(second));
        System.out.println("distance(2,2)= " + first.distance(2, 2));

        Q_9_point point = new Q_9_point();
